...
const Contact = () => {
  return (
    <>
      <div
        name="contact"
        className="pt-[9rem]  w-full h-auto bg-[#0a192f] flex justify-center items-center p-4 contact"
      >
        <form
          method="POST"
      ...
      {/* footer */}
      <div className="footer w-full pt-[6rem] pb-[1rem] bg-[#0a192f] flex justify-center items-center text-gray-300">
